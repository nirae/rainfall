...
The program increase the size of 2 global variables (auth and service) with malloc, 10 by 10, when the input is "auth " or "service"
...
So, we can understand what we need to do : init the auth variable, increase the service variable until the service variable write at auth+32
